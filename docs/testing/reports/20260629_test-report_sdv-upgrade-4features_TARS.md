...
- 기능 4: **PASS** (Dylan 실기 확인 2026-06-30 — .md 더블클릭 MMM 디폴트 유지 + 우클릭 "연결 프로그램"에 SDV 등장, 디폴트 비가로채기 확인. NSIS 조정 불필요)
...
## 4. 기능4 파일연결 — PASS (실기 확인 2026-06-30)

**실기 결과(Dylan, 2026-06-30, v0.80.1 설치)**: .md 더블클릭 = MMM 디폴트 유지(가로채기 없음), 우클릭 "연결 프로그램"에 SDV 등장. 예상대로 Tauri 기본 fileAssociations가 디폴트를 건드리지 않음. NSIS 조정 불필요.
